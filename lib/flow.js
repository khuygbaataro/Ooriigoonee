...
Шилжүүлэг хийсний дараа «Гүйлгээ амжилттай» гэсэн баримтынхаа ЗУРГИЙГ энэ чат руу илгээгээрэй 📸
...
async function sendUpsell(psid, profile) {
  ...
  await fb.sendText(psid, bankInstructions());
...
async function handleReceipt(psid, session, imageUrl) {
  ...
  const verdict = judgeReceipt(proof);
