...
export async function installMenu() {
  return call('me/messenger_profile', {
    ...
    greeting: [
      {
        locale: 'default',
        text: 'Өөрийгөө хэр сайн мэддэг вэ? 👀 10 асуулт асууя — нэг минут ч болохгүй. Төлбөр ч, бүртгэл ч байхгүй ✨',
      },
    ],
    persistent_menu: [
      {
        ...
        call_to_actions: [
          { type: 'postback', title: '💬 Ярилцах', payload: 'CHAT' },
          { type: 'postback', title: '📄 Миний дүр зураг', payload: 'MY_RESULT' },
