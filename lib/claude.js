...
// ── 2. БҮРЭН ТАЙЛАН — БҮГДЭД НЬ, ҮНЭГҮЙ ─────────────────────────────────
...
const APPLIED_FORMAT = jsonFormat({
  ...
  stress: str,
  growth_tips: strList,
  mirror_questions: strList,
});

/**
 * Дэлгэрэнгүй тайлан.
 *
 * ⚠️ Нэг дуудлагаар бүх бүлгийг бичихэд 60с-д БАГТАХГҮЙ. Тиймээс тайланг
...
Аль хэдийн гаргасан товч тусгал:
...
- Анзаардаггүй тал: ${profile.blind_spot}`;
  ...
  return {
    ...
    mirror_questions: Array.isArray(applied.mirror_questions) ? applied.mirror_questions : [],
  };
}

// ── 3. ХӨТӨЧИЙН ХАРИУЛТ (профайлтай хүн) ────────────────────────────────
...
// ── 3.5. УРТ ХУГАЦААНЫ САНАХ ОЙГ ШИНЭЧЛЭХ ───────────────────────────────
