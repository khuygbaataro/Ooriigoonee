...
export const config = {
  ...
  /**
   * ДАВТАГДДАГ ажлыг аль давхарга хийх вэ: 'openai' (хямд) | 'claude' (гүн).
   * Хамрах хүрээ: яриа бүр + санах ойн тэмдэглэл.
   *
   * ⚠️ ЗАРДЛЫН ГОЛ ТОХИРУУЛГА. Өдөрт 500 хүн × 20 мессеж = 10,000 дуудлага.
   *    Үүнийг үнэтэй загвар дээр тавьбал зардал ХҮНЭЭС биш МЕССЕЖЭЭС
   *    хамаарч өснө — яриа чөлөөтэй байх тусам зардал өснө гэсэн үг.
   *
   * ⚠️ Анализ ба бүрэн тайлан нь ЭНД ХАМААРАХГҮЙ — тэдгээр нь хүн тутамд
   *    нэг удаа тул үргэлж anthropicModel дээр ажиллана.
   *
