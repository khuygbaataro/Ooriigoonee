...
test('lib/flow.js доторх илгээгдэх текстэд мөнгөний үг байхгүй', () => {
  ...
  /**
   * Цорын ганц зөвшөөрөгдсөн мөр — мэндчилгээн дэх «Төлбөр ч, бүртгэл ч
   * байхгүй.» Энэ нь мөнгө гуйхын ЭСРЭГ: хүмүүс хуучин төлбөртэй хувилбарыг
   * санаж «дараа нь мөнгө нэхэх байх» гэж эргэлздэг тул түүнийг нь эхэндээ
   * арилгана.
   */
  const ALLOWED = 'Төлбөр ч, бүртгэл ч байхгүй';
